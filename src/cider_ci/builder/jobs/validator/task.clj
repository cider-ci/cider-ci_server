(ns cider-ci.builder.jobs.validator.task
  ...
  (:require
    ...
    [cider-ci.builder.jobs.validator.attachment :refer [validate-attachment!]]
    [cider-ci.builder.jobs.validator.git-options :refer [validate-git-options!]]
    [cider-ci.builder.jobs.validator.template :refer [validate-template!]]
