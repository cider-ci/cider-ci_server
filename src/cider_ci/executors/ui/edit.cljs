...
(ns cider-ci.executors.ui.edit
  ...
  (:require
    ...
    [cider-ci.executors.shared :refer [allowed-keys]]
    [cider-ci.executors.ui.form :as form]
    [cider-ci.executors.ui.shared :refer [reload-executors executor-not-found-component]]
