(ns cider-ci.server.repository.ui.core
  (:require
    [cider-ci.server.repository.ui.navbar :as navbar]
    [cider-ci.server.repository.ui.debug]
    [cider-ci.server.repository.ui.projects.edit-new.core :as projects.edit-new.core]
    [cider-ci.server.repository.ui.projects.index :as projects.index]
    [cider-ci.server.repository.ui.projects.show :as projects.show]
...
(secretary/defroute (str CONTEXT "/ui/debug") []
  (swap! state/page-state assoc :current-page
         {:component #'cider-ci.server.repository.ui.debug/page}))
