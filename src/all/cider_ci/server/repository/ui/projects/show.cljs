(ns cider-ci.server.repository.ui.projects.show
  (:require-macros
  ...
  (:require
    ...
    [cider-ci.server.repository.branches.ui :as branches]
    [cider-ci.server.repository.fetch-and-update.ui :as fetch-and-update]
    [cider-ci.server.repository.push-hooks.ui :as push-hooks]
    [cider-ci.server.repository.push-notifications.ui :as push-notifications]
    [cider-ci.server.repository.status-pushes.ui :as status-pushes]
    [cider-ci.server.repository.ui.projects.orientation :as orientation]
    [cider-ci.server.repository.ui.projects.shared :as projects-components]
