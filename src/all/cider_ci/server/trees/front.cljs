...
(ns cider-ci.server.trees.front
  ...
  (:require
    ...
    [cider-ci.server.trees.front-shared :as shared :refer [tree-id*]]
...
(defn page-is-active? []
  (= :tree (-> @state/routing-state* :handler-key)))
