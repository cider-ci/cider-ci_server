(ns cider-ci.server.builder.jobs.validator.git-options
...
(defn validate-submodules! [submodules chain]
  (validate-spec-map! submodules submodules-meta-spec chain)
...
(defn validate-git-options! [git-options chain]
  (validate-spec-map! git-options git-options-meta-spec chain))
