(ns cider-ci.server.repository.project-configuration.expansion-tests
  (:require
    [cider-ci.server.repository.project-configuration.expansion :refer :all]
...
(deftest hot-spot
  (with-redefs [cider-ci.server.repository.project-configuration.shared/get-content
                (fn [& args] (apply get-content args))
                cider-ci.server.repository.project-configuration.shared/resolve-submodule-git-ref
